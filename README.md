...
данных таким же образом как и перед тренировкой модоли. То есть мы создаем мини датасет для того, чтобы модель предсказала 0 или 1. Все это происходит в функции trading в файле consumer.py

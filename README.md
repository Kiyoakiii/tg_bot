...
! Важно отметить, что не получилось реализовать в данном разделе. Я подумал, что круто было бы реализовать LSTM + ССА или для предобработки последовательности использовать гауссовские процессы. Но потратив недельку понял, что  времени не хватит. 
